...
{% hint style="info" %}
의도와 기능에 대한 자세한 내용은 [Play](play.md)를 참고하세요.
{% endhint %}
...
{% hint style="info" %}
User Utterance Model 모델에 대한 자세한 내용은 [User Utterance Model 정의하기\(Intent & Entity\)](../create-plays-with-play-builder/define-user-utterance-model/)를 참고하세요.
{% endhint %}
